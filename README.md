...
### [default](generator.js#L42)

Scaffold out a [consolidate](https://github.com/visionmedia/consolidate.js)-style engine project.
...
### [test](generator.js#L68)

Write a `test.js` file with [mocha](https://github.com/mochajs/mocha)-style unit tests for your engine.
